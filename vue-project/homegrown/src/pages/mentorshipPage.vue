<template>
  <div>
    <section id="ongoing_app" class="container py-3">
      ...
      <div
        v-if="!mentorships_loading && courses.length == 0"
            ...
            <div class="card shadow-sm position-relative hover-animate">
              ...
              >
                ...
                <div class="card-body">
                  ...
                  <h6
                    class="text-secondary card-text text-center fst-italic enter-text"
                  >
                    click to enter
                  </h6>
                  <!-- Updated here -->
    ...
    <section id="new_app">
      <div class="container py-5">
        ...
        <div v-else>
          <div class="row g-4">
            <div
              v-for="course in availableMentorships"
              :key="course.id"
              class="col-md-6"
            >
              <div class="card d-flex flex-column h-100">
                ...
                <button
                  class="btn btn-view-info btn-position m-15"
    ...
    <div
      ...
      id="mentorModal"
      tabindex="-1"
      aria-labelledby="mentorModalLabel"
      aria-hidden="true"
    >
  ...
  methods: {
    ...
    async uploadFile(file, courseId) {
      const storageRef = ref(
        this.storage,
        `mentorships/${courseId}/${file.name}`
      );
      try {
        await uploadBytes(storageRef, file);
        const fileURL = await getDownloadURL(storageRef);
        await updateDoc(doc(db, "mentors", courseId, "documents", file.name), {
          fileURL: fileURL,
