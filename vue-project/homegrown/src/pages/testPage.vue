<template>
  <div>
    <button @click="addLessonWithItems">Add Lesson with Items to Firebase</button>
  </div>
</template>
  ...
  methods: {
    async addLessonWithItems() {
      try {
        ...
        const lessonItemsRef = collection(db, `courses/${courseId}/lessons/${lessonId}/lesson_items`);

        // Add lesson_item_001 (Video)
        await setDoc(doc(lessonItemsRef, "lesson_item_001"), {
          description: "In this lesson, you will dive into the fundamental concept of variables in Python...",
        ...
        const questions = [
          {
            ...
            options: { A: "1_variable", B: "variable_1", C: "variable-name", D: "variable name" },
            correct_answer: "B"
          },
          {
            question_number: 2,
            type: "multiple_choice",
            question: "What is the output of the following code: `x = 5; print(x)`?",
          ...
          },
          {
            question_number: 4,
            type: "multiple_choice",
            question: "How can you declare a variable named `num` and assign it the value 10?",
            options: { A: "`var num = 10`", B: "`num <- 10`", C: "`num = 10`", D: "`let num = 10`" },
            correct_answer: "C"
          },
          {
            question_number: 5,
            type: "multiple_choice",
            question: "What will happen if you try to use an undefined variable?",
            options: { A: "An error is raised", B: "It returns None", C: "The program continues", D: "It assigns 0 by default" },
            correct_answer: "A"
          },
          ...
          },
          {
            ...
            options: { A: "Mutable", B: "Immutable", C: "Fixed", D: "Constant" },
            correct_answer: "A"
          },
          {
            question_number: 8,
          ...
          },
          {
            ...
            options: { A: "variable1", B: "_variable", C: "variable$", D: "variable_name" },
            correct_answer: "C"
          },
          {
            question_number: 10,
